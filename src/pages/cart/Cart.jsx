          ...
          <div className="rounded-3xl md:w-2/3 h-[500px] overflow-auto">
            {cartItems.map((item, index) => {
              ...
              >
                ...
                <div className="mt-4 -ml-5 md:mt-0 flex flex-col md:flex-row items-center justify-between">
                  ...
                  <div
                    ...
                    className="text-red-600 mt-4 md:mt-0 cursor-pointer flex items-center justify-center"
                  >
