    ...
    return (
       <section className='lg:grid lg:grid-cols-2 '>
        <div className="lg:block hidden">
            <img src="/bg2.jpg" alt="" className='object-cover w-full h-screen rounded-r-3xl' />
        </div>
        ...
        <div className="flex justify-center items-center h-screen   ">
            ...
            <div className="bg-white px-10 py-10 rounded-xl  max-w-sm w-full">
                ...
                <div className="flex justify-center mb-4">
                    <button
                        onClick={login}
                        className="bg-gradient-to-r from-blue-300 via-blue-600 to-blue-600 text-white font-bold w-full px-4 py-2 rounded-2xl shadow-md hover:bg-blue-700 transition duration-200 ease-in-out"
                    >
                        Login
                    </button>
                </div>
